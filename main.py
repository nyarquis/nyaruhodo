...
os.chdir(os.path.expanduser('~/Documents/GitHub/nyaruhodo'))
...
def scan():
    ...
    if file:
        ...
        detected_type = result.get('filetype') or result.get('original_filetype')
        metadata = nyaruhodo.properties.extract(filepath, detected_type)
        ...
        if result['mismatch'] and flask.request.form.get('virustotal') == 'true':
            ...
            virustotal = nyaruhodo.services.scan(filepath)
