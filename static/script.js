...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (deleteAccountButton && deleteAccountModal) {
        ...
        if (deleteAccountModal.getAttribute("data-open") === "true") {
            deleteAccountModal.classList.remove("is-hidden");
        }
    }
